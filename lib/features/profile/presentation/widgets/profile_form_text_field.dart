...
// ─────────────────────────────────────────────
//  PROFILE FORM TEXT FIELD  —  Premium Dark VIP Edition
// ─────────────────────────────────────────────
...
class ProfileFormTextField extends StatefulWidget {
  ...
  @override
  State<ProfileFormTextField> createState() =>
      _ProfileFormTextFieldState();
}
...
class _ProfileFormTextFieldState extends State<ProfileFormTextField>
  ...
  IconData _prefixIcon() {
    ...
    if (l.contains("username")) return Icons.alternate_email_rounded;
    if (l.contains("age"))      return Icons.cake_outlined;
    if (l.contains("email"))    return Icons.mail_outline_rounded;
    if (l.contains("bio"))      return Icons.notes_rounded;
    ...
    return AnimatedBuilder(
      ...
      builder: (_, child) {
        ...
        final borderColor = Color.lerp(
          _hasText ? _goldA.withOpacity(0.35) : _border,
          _goldA.withOpacity(0.75),
          _borderAnim.value,
        )!;
